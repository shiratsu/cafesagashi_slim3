...
public class UploadedDataFragment implements Serializable {
    ...
    private org.slim3.datastore.ModelRef<enjoyCafe.model.UploadedData> uploadDataRef =
        new org.slim3.datastore.ModelRef<enjoyCafe.model.UploadedData>(
                enjoyCafe.model.UploadedData.class);
