...
public class ApiPostCafeServiceUpdate2 {
     ...
     * @return
     */
    public Key postData(Map<String, Object> input) {
        //データをbeanにコピーして投稿する
...
System.out.println("storeName:"+EscapeUtil.toHtmlStringForObject(input.get("storeName"))); 
     ...
     */
    public Key updateData(Map<String, Object> input) throws EntityNotFoundException {
        ...
        //2011-01-10 iPhoneからの更新時は、緯度経度系は更新しない
        /*
        if(input.get("geohash4") != null && !"".equals(input.get("geohash4")) && !"(null)".equals(input.get("geohash4"))){
        ...
        */
        ...
        cafeEntity.setProperty("updateDate", new Date());
     ...
     * @throws EntityNotFoundException 
     */
    public Key deleteData(Map<String, Object> input) throws EntityNotFoundException {
