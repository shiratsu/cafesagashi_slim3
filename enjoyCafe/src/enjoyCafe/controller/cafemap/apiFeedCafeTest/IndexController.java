package enjoyCafe.controller.cafemap.apiFeedCafeTest;
...
//import enjoyCafe.service.ApiFeedCafeMapService;
import enjoyCafe.service.ApiFeedCafeTestService;

public class IndexController extends Controller {

    private ApiFeedCafeTestService service = new ApiFeedCafeTestService();
    ...
    public Navigation run() throws Exception {
        ...
        if(request.getParameter("search") != null){
          ...
          //検索フラグの作成
            ...
            searchFlag = true;
            cafeList = service.feedApiCafeList(input);
