...
public class Geohash {
  ...
  public static String[] feedGeohashAry(String geoHash){
	  String[] param = geoHash.split("");
	  String from = "000000";
	  String to = "zzzzzz";
	
	  //geohashのfromをまず作成
	  String geoFrom = param[1]+param[2]+param[3]+param[4]+param[5]+param[6]+from;
	  String geoTo = param[1]+param[2]+param[3]+param[4]+param[5]+param[6]+to;
	  String[] returnAry = {geoFrom,geoTo};
	  return returnAry; 
  }
